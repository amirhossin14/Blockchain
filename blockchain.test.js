...
describe("Blockchain", () => {
  ...
  it("adds a nwe block to the chain", () => {
  ...
  describe("isValidChain", () => {
    describe("when the chain does not start with the gebesis block", () => {
      it("returns false", () => {
    ...
    describe("when the chain does start with the gebesis block and has multiple blocks", () => {
      beforeEach(() => {
