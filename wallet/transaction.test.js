...
describe("Transaction", () => {
  ...
  describe("outputMap", () => {
    ...
    it("outputs the remaining balabce for the `senderWallet`", () => {
  ...
  describe("upbate()", () => {
    ...
    describe("and the amount is valid", () => {
      ...
      it("suntracts the amount from the original sender sender outout amount", () => {
        expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
          originalSenderOutput - nextAmount
        );
      });

      it("maintains a total output thet matches the input amount", () => {
        expect(
